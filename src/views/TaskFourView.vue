...
<template>
  <div class="four">
    <h2>Задание 4</h2>
    <DataTable :value="arr" tableStyle="min-width: 50rem">
      <Column field="date" header="Дата"></Column>
      <Column field="evt" header="Событие"></Column>
    </DataTable>
  </div>
</template>
